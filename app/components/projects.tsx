...
return(
    <section className="max-w-6xl mx-auto p-20">
        ...
        <div className="flex flex-row justify-around space-y-10">
            ...
            <Card className="space-x-3 w-75 h-75 p-5 shadow-xl/30 grid content-center bg-background text-foreground hover:bg-foreground hover:text-background">
            ...
            <Card className="space-x-3 w-75 h-76 p-5 shadow-xl/30 grid content-center bg-background text-foreground hover:bg-foreground hover:text-background" id="danca">
                <div className="flex flex-row justify-center">
                <Github className="w-5 h-5"></Github>
                </div>
            ...
            <Card className="space-x-3 w-75 h-75 p-5 shadow-xl/30 grid content-center bg-background text-foreground hover:bg-foreground hover:text-background" id="tatuagem">
                <div className="flex flex-row justify-center">
                <Github className="w-5 h-5"></Github>
                </div>
        ...
        <div className="flex flex-row justify-around space-y-10">
            ...
            <Card className="space-x-3 w-75 h-75 p-5 shadow-xl/30 grid content-center bg-background text-foreground hover:bg-foreground hover:text-background" id="constucao">
                <div className="flex flex-row justify-center">
                <Github className="w-5 h-5"></Github>
                </div>
            ...
            <Card className="space-x-3 w-75 h-75 p-5 shadow-xl/30 grid content-center bg-background text-foreground hover:bg-foreground hover:text-background" id="viagens">
                <div className="flex flex-row justify-center">
                <Github className="w-5 h-5"></Github>
                </div>
            ...
            <Card className="space-x-3 w-75 h-75 p-5 shadow-xl/30 grid content-center bg-background text-foreground hover:bg-foreground hover:text-background" id="eventos">
                <div className="flex flex-row justify-center">
                <Github className="w-5 h-5"></Github>
                </div>
        ...
        <div className="flex flex-row justify-center space-y-10">
            ...
            <Card className="space-x-3 w-75 h-75 p-5 shadow-xl/30 grid content-center bg-background text-foreground hover:bg-foreground hover:text-background" id="transportadora">
